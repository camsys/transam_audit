...
ActiveRecord::Schema.define(version: 20170103225100) do
  ...
  create_table "audit_result_types", force: true do |t|
    t.string  "name",        limit: 32,  null: false
    t.string  "description", limit: 254, null: false
    t.boolean "active",                  null: false
  end

  create_table "audit_results", force: true do |t|
  ...
  add_index "audit_results", ["audit_id"], name: "audit_results_idx1", using: :btree
  add_index "audit_results", ["audit_result_type_id"], name: "audit_results_idx4", using: :btree
  add_index "audit_results", ["auditable_type", "auditable_id"], name: "audit_results_idx2", using: :btree
  add_index "audit_results", ["class_name"], name: "audit_results_idx3", using: :btree
  ...
  add_index "audits", ["active"], name: "audit_idx2", using: :btree
  add_index "audits", ["object_key"], name: "audit_idx1", using: :btree
