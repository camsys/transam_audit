...
ActiveRecord::Schema.define(version: 2020_04_22_165110) do
  ...
  create_table "audit_result_types", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name", limit: 32, null: false
    t.string "description", limit: 254, null: false
    t.boolean "active", null: false
  end

  create_table "audit_results", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
